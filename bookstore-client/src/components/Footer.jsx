...
const Footer = () => {
  ...
  return (
    <div className='flex flex-col list-none  bg-gradient-to-r from-indigo-700 to bg-indigo-700 via-indigo-600  text-[hsl(39,100%,93%)] p-2'>
    <footer  id='contact' className=' flex gap-5 py-[2%] md:flex-row flex-col md:justify-between justify-center items-center md:px-[1%] md:pb-[2%] md:items-start list-none bg-[#6ae8f1]] text-[rgb(255,243,220)]'>
      <div className='mx-10 w-1/6 flex flex-col justify-start items-start gap-3 text-2xl'>
        ...
        <nav className=' flex flex-col items-center bg-indigo-400 bg-opacity-70 md:h-[25vh] md:py-0 py-4 h-auto px-4 rounded-xl shadow-md duration-300 ease-out hover:shadow-lg md:w-[300px] w-[280px]  shadow-blue-300'>
        ...
        <nav className='support flex flex-col items-center bg-indigo-400 bg-opacity-70  md:h-[25vh] md:py-0 py-4 h-auto px-4 rounded-xl shadow-md duration-300 ease-out hover:shadow-lg md:w-[300px] w-[280px] shadow-blue-300'>
        ...
        <nav className='terms flex flex-col items-center bg-indigo-400 bg-opacity-70  md:h-[25vh] md:py-0 py-4 h-auto px-4 rounded-xl shadow-md duration-300 ease-out hover:shadow-lg md:w-[300px] w-[280px] shadow-blue-300'>
