...
const Footer = () => {
  ...
  return (
    <div className='flex flex-col list-none  bg-[#041438]  text-[hsl(39,100%,93%)] p-2'>
    <footer  id='contact' className=' flex gap-5 py-[2%] md:flex-row flex-col md:justify-between items-center md:px-[1%] md:pb-[2%] md:items-start list-none bg-[#6ae8f1]] text-[rgb(255,243,220)]'>
      {/* <div className='md:mx-10 mx-1  w-1/6 flex md:flex-col  md:justify-start md:items-start gap-3 text-2xl'>
      ...
      <div>
      <span className=' text-white text-6xl font-extrabold text-opacity-90'>Book<span className='text-[#8ab1e5] poetsen-one-regular'>Haven</span></span>

        <p>

        </p>
      </div>
        <nav className=' flex flex-col items-center bg-inherit bg-opacity-70 md:h-[25vh] md:py-0 py-4 h-auto px-4 rounded-xl  duration-300 ease-out  md:w-[300px] w-[280px] '>
        <li className=' text-2xl   font-bold my-2'>BookHaven</li>
        ...
        <nav className='support flex flex-col items-center bg-inherit bg-opacity-70  md:h-[25vh] md:py-0 py-4 h-auto px-4 rounded-xl  duration-300 ease-out  md:w-[300px] w-[280px] '>
        <li className='text-2xl   font-bold my-3'>Support</li>
        ...
        <nav className='terms flex flex-col items-center bg-inherit bg-opacity-70  md:h-[25vh] md:py-0 py-4 h-auto px-4 rounded-xl  duration-300 ease-out  md:w-[300px] w-[280px] '>
          <li className='text-2xl   text-wrap font-bold my-3'>Terms and Privacy</li>
